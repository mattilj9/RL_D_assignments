...
class Agent(object):
    def __init__(self, env_name, state_space, n_actions, replay_buffer_size=50000,
        ...
        self.env_name = env_name  #added by jjm
    ...
    def get_action(self, state, epsilon=0.05):
        ...
        with torch.no_grad():
            qs_actions = self.policy_net.forward(state)

        max_action_index = torch.argmax(qs_actions)
        action_index = max_action_index.numpy()
